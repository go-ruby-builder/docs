...
Contributions are welcome. `go-ruby-builder/builder` is built to a small set of
...
The library is in [`github.com/go-ruby-builder/builder`](https://github.com/go-ruby-builder/builder).
This documentation site is in [`github.com/go-ruby-builder/docs`](https://github.com/go-ruby-builder/docs).
