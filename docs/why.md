...
`go-ruby-builder/builder` reimplements Ruby's `builder` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-builder/builder` directly, with no Ruby runtime;
