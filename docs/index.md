# go-ruby-builder documentation

**Pure-Go (CGO=0) MRI-faithful Ruby builder**

`go-ruby-builder/builder` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `builder`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `builder`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`builder`](https://github.com/go-ruby-builder/builder) | the library — Ruby's `builder` in pure Go |
| [`docs`](https://github.com/go-ruby-builder/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-builder.github.io`](https://github.com/go-ruby-builder/go-ruby-builder.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-builder/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-builder/builder](https://github.com/go-ruby-builder/builder).
