...
The public API lives at the module root (`github.com/go-ruby-builder/builder`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `builder`, while the surface follows
...
```go
import "github.com/go-ruby-builder/builder"
```
...
- **[pkg.go.dev/github.com/go-ruby-builder/builder](https://pkg.go.dev/github.com/go-ruby-builder/builder)**

The module's [README](https://github.com/go-ruby-builder/builder#readme) carries worked
